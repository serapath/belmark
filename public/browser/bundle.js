(function () {
  ...
  socket.setAttribute('src', 'http://127.0.0.1:1342/socket.io/socket.io.js')
  script.type = 'text/javascript'

  socket.onload = function () {
    document.head.appendChild(script)
  }
  script.text = ['window.socket = io("http://127.0.0.1:1342");',
...
},{"global/document":3,"global/window":4}],9:[function(require,module,exports){
var bel = require('bel')
...
},{"bel":1,"marked":7}],10:[function(require,module,exports){
var marked = require('marked')
var bel = require('bel')
...
},{"../source/belmark":9,"bel":1,"marked":7}]},{},[10]);
